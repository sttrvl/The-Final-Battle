...
// maybe I overdid it with the namespaces, not sure

namespace TheFinalBattle.GameObjects
{
...
namespace TheFinalBattle.GameObjects.Gear
{
...
namespace TheFinalBattle.GameObjects.MenuActions
{
